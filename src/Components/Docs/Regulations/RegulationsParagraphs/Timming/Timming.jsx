    ...
    return (
        <div className={styles.timming}>
            ...
            <ul>
                ...
                {cs && <li>3.3 Таймаут на бан карт и ожидание игрока в лобби - {banCartTime} минут после определения
                    оппонента.</li>}
                <li>3.4 Таймаут на подтверждение счета после завершения игры или открытия спора -
                    5 минут
                </li>
                <li>3.5 Сообщение о нарушении, предоставление доказательств нарушения - 15 минут
                    после окончания матча.</li>
            </ul>
        </div>
    );
